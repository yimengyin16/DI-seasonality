...
## Figure X11 only, Aug 2021 not hardcoded as outlier
...
plot_impact <- function(DIType_slc, method_slc, fill_slc = "blue"){
# DIType_slc <- "SSDI"
# method_slc <- "X11"
...
# Need to reconcile the reconcile the results: 
# Why don't see large positive impacts in Nov, Dec and Jan, which are observed in the preliminary comparison figures? 
