...
all0 <- read.csv("Data/MOWL/SSA-SA-MOWL-2022-04.csv", header = FALSE)
...
# Note: as of 5/24/2022, the code above loads extra cols beyond 79. Only use col 1:79
names(all0) = NAME[1:79]
rm(NAME)
...
# Creating nationwide sum for each month in each year. (including special agencies)
