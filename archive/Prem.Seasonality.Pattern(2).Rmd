...
# Function for making seasonal plots for a single state
...
fig_compare <- 
  ...
  labs(x = NULL,y = "Seasonal component",
       title = paste0("Comparing seasonal patterns, ", state_slc)) 
...
fig_season_allStates <- 
  map(states_order, plot_season)
# fig_season_allStates


cairo_pdf(paste0("paper_plot/fig_explore/", "fig_patterns.pdf"), width = 30*0.7, height = 20*0.7, onefile = T)
fig_season_allStates
dev.off()
