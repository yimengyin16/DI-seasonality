# A summary of data files------------------------------
  # 1. all.RData:
      # Generated by: importData.R
      # Data frame included:
        # all0: original series. 
        # all: all application series, with differing length of months
        # all.same: all application series, with equal length of months
  # 2. SA.all.same.RData
      # Generated by: SA.import.same.R
      # Data frames: outcome of X13 for each application series, with euqal length of Months
        # all.SA.Total
        # all.SA.Title.2
        # all.SA.Title.16
        # all.SA.Concurrent
        ...
        # all.SA.SSI
      # vectors
        # SA.state: abbr of states that are imported, 50 states + NW
  # 3. SA.all.RData : 
        # Generated by: SA.import.R 
        # similar to SA.all.same.RData, but with differing length of months
  # 11. SA.all.df.RData
      # Generated by: SA.import.df.R
      # Data frames: outcome of X13 for series adjusted with different monthly weights.
        # all.SA.Total.df
        # all.SA.Title.2.df
        # all.SA.Title.16.df
        # all.SA.Concurrent.df
  # 4. SA.sum.same.RData
      # Generated by SA.outcome.same
      # Data frames: strengh of seasonality and average monthly seasonal factors
        # SA.sum.Total
        # SA.sum.Title.2
        # SA.sum.Title.16
        # SA.sum.Concurrent
        ...
        # SA.sum.SSI
  # 5. emply.RData
      # generated by: importBLS.R
      # Dataframe:
        # emply: seasonally adjusted and unadjusted series of 
        #        unemployment rate, employment, unemployment, labor force,
        #        and their seasonal factors calculated as ratio of unadjusted and adjusted series.
  # 6. TableNW.RData
      # generated in seasonalDummy.Rmd,summarizes magnitudes and seasonal patterns from
      # dummy approach and X13 approach
      # Dataframes:
        # tab.strength.NW : R2 from dummy, strength from X13
        # tab.pattern1.NW : dummy
        # tab.pattern2.NW : X13
  # 7. sDummy.sum.same.RData
      # generated in seasonalDummy.Rmd, summarizing seasonal dummies for each state
      # Data frames:
        #tab.dummy.Title2, 
        #tab.dummy.Title16, 
        #tab.dummy.Concurrent,
        #tab.dummy.unemply
  # 8. reg.data.RData, reg.data.trans.RData.
       # Transformed reg.data for analysis of heterogeneity in slopes
       # Created by Data.Transform.R.
  # 9. Macroecon.RData
       # Selected macroeconomic variables for analysis of seasonality in current 
       # US economy. created by importFR.R.
      # Dataframes:
        # IP.Total: Index of Industrial Production, national
        # hour.earn.NW: work hours and hourly earnings for 3 industries, national level
  # 10. SA.all.same.dl.RData
      # Generated by: SA.import.same.dl.R
      # Data frames: outcome of X13 for each log growth rate series, with euqal length of Months
        # all.SA.dlTotal
        # all.SA.dlTitle.2
        # all.SA.dlTitle.16
        # all.SA.dlConcurrent
  ...
  # 12. panel.RData
      # Generated by Combine.Data.R
       


# Create a data frame for seasonal model, reg.data ----------------------------------- 
setwd("E:\\SkyDrive\\Working\\Third year\\00 R programs\\01 Seasonal Adjustment")
