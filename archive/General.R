...
setwd("E:\\SkyDrive\\Working\\Third_year\\00_R_programs\\01_Seasonal_Adjustment\\New")
...
select = function(category, region, data, start = c(2000, 10),end = c(2014,5), zoo = FALSE,
...
select2 = function( region, data = reg.data, start = c(2000, 10),end = c(2013,1)){
