...
#' Figures and tables for the seasonality paper
...
# Figure 4: apply&unemplyLag.pdf 
#   - Plot_Seasonal_Dummies

# Figure 5: BoxplotDummycoeff.pdf
#   - Boxplot

# Figure 6: Allow_App_Dummies_AG.pdf
#   - State_by_State_Comparison_plots




# Table 1:
#  - See Paper_seasonality.R

# Table 2: Magnitudes of Seasonality in Disability Applications
#  -  Table_of_R^2_for _top_5

# Table 3: "Coefficients of Seasonal Dummies: Growth Rate of National Aggregate"
#  - Table_of_seasonal_dummies_for_nationawide

# Table 4: Test for heterogeneity of seasonality
# -  PYtest

# Table 5: "Relationship between deterministic seasonal components of DB application and 1 month lag of unemployment"
#  - seasonal_IV_Top5


# Table 6 
# - Seasonality.SeasonUroot.Rmd: Tables_of_HEGY_test

# Table 7
# - Seasonality.Univariate_Granger: GC_results_of_multiple_states



# For Table A1-A3 in appendix
# - Table_of_R2_and_seasonal_dummies_for_top5
